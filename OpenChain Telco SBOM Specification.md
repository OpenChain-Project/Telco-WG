...
To indicate that the software has a conformant SBOM available, you may use the following statement: “This SBOM is conformant with version 1.0 of the OpenChain Telecommunications Group SBOM Specification"
