...
### 事業体
事業体（entity）とは、第三者（他の組織または個人など）にソフトウェアを頒布する法人（営利、非営利、または、個人）を意味する。事業体には、他のグループ会社、または事業体の共通支配下にある会社は含まれない。
...
#### 3.9.2 根拠
現在のところ、SaaSで提供されるサービスのSBOMが何を含むべきかについて、業界のコンセンサスは得られていない。
